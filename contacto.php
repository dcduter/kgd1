...
<main class="contenedor seccion top">
  ...
  <picture>
    ...
    <img loading="lazy" src="build/Simbolo-KGD.webp" alt="imagen contacto" class="imagen-logo"/>
  </picture>
  ...
  <form
    ...
    <fieldset>
      ...
      <div class="contacto">
        ...
        <input name="contacto" type="radio" value="telefono" id="contactar-telefono" name="Medio de contacto" />

        <label for="contactar-correo">Correo</label>
        <input name="contacto" type="radio" value="email" id="contactar-correo" name="Medio de contacto" />
      </div>
